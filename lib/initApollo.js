...
function create (initialState, withSubscription = false) {
  const networkInterface = createNetworkInterface({
    uri: 'https://api.graph.cool/simple/v1/cj8ypa9sx038s018686140dpr', // Server URL (must be absolute)
  ...
  if (withSubscription) {
    ...
    const wsClient = new SubscriptionClient('wss://subscriptions.ap-northeast-1.graph.cool/v1/cj8ypa9sx038s018686140dpr', {
      reconnect: true,
      connectionParams: {
        authToken: getToken
      }
